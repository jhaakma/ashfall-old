...
function this.wetnessIndicator()
    ...
    if not common.config.conditions.wetness.states[common.data.currentStates.wetness] then return end

    local headerText = "Wet level: " .. common.config.conditions.wetness.states[common.data.currentStates.wetness].text--:lower()
...
function this.conditionIndicator()
    if not common.data then return end
    if not common.config.conditions.temp.states[common.data.currentStates.wetness] then return end 
    
    local headerText = "Condition: " .. common.config.conditions.temp.states[common.data.currentStates.wetness].text--:lower()
